...
const activity_center_state_exports = {};
module.exports = __toCommonJS(activity_center_state_exports);
...
function stateWithNoClaimableDay(identity, day, serverTime, observedAt = (/* @__PURE__ */ new Date()).toISOString()) {
